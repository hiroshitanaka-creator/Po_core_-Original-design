...
def test_script_json_output():
    ...
    # 6 valid examples (base + 1 added by PR-015 + 1 added by PR-016 + 1
    # added by PR-017 + 2 added by PR-018) + 12 invalid examples (3
    # pre-PR-014 + 4 added by PR-014 for Po_trace_blocked / Po_self_seedling
    # / Semantic Jump Tensor + 1 added by PR-015 for blocked trace
    # reactivation planning + 1 added by PR-016 for blocked trace
    # reactivation proposal execution + 1 added by PR-017 for semantic jump
    # frame proposal execution + 2 added by PR-018 for the semantic jump
    # human review gate).
